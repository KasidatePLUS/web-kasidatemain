...
feednami.load(hoturl)
  .then(feed => {
    ...
    <div class="uk-flex-middle uk-text-top" uk-grid uk-card uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 500">
        ...
        <div class="uk-width-2-3@m uk-text-default uk-text-normal thai uk-text-top uk-link-heading" uk-scrollspy-class="uk-animation-slide-top">
             <a href="${entry.link}" > <span class="uk-label uk-label-danger">HOT NEWS</span> <br>
             ${entry.title}
             </a>
        </div>
